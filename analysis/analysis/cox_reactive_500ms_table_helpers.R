...
build_footer_2col <- function() {
  c("   \\midrule \\midrule",
    ...
    paste0("   \\multicolumn{3}{l}{\\emph{Sample restricted to rows with",
           " group\\_sold\\_prev\\_period $=$ 1 (person-periods immediately",
           " following a group-mate's sale).}} \\\\"),
    paste0("   \\multicolumn{3}{l}{\\emph{Event: any sale within the",
           " restricted risk set; equals the reactive\\_sale count under",
           " the restriction.}} \\\\"),
    paste0("   \\multicolumn{3}{l}{\\emph{HR $>$ 1: increased hazard of a",
