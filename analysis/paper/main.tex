...
$u=w^{\theta}$ and use $\theta$ as risk tolerance (consistent with trait measure).

Calculate $\overline{\tau}$ and  $\underline{\tau}$ for Treatment 1 and Treatment 2 given $\theta=1,0.5,1.5$? Perhaps we can show something like Figure 6 in Magnani and Munro (they use prob of bad but we use prob of good).
