...
Table 4 Tobit regression. 2 columns:

Model (1) No of Sellers on Treatment2 Segment2 Segment3 Segment4 Round

Model (2) No of Sellers on Treatment2 Segment2 Segment3 Segment4 Round BadState

\subsubsection{First Sellers}

Table 5 Pooled OLS. 4 columns:

Model (1)  Belief at first sale on Treatment2 Segment2 Segment3 Segment4 Round

Model (2)  Belief at first sale on Treatment2 Segment2 Segment3 Segment4 Round BadState

Model (3) Period of first sale  on Treatment2 Segment2 Segment3 Segment4 Round

Model (4) Period of first sale  on Treatment2 Segment2 Segment3 Segment4 Round BadState


Table 6 Cox survival model. 4 columns:

Model (1)  First sellers only on all variables like Model (4) in Table 11

Model (2)  Reactive sellers only (rushed second sellers) on all variables-fear, surprise, female 

Model (3)  Sellers only on all variables

Model (4)  all participants (sellers and non-sellers) on all variables-valence, female



\subsubsection{Rushed Second Sellers}

Refer to Table 6 model (2)
...
Refer to Table 6 model (3)

Refer to Table 6 model (4)



Table 7 Rank-ordered logit model. 2 columns:

Model (1)  Sellers only on all variables (same period, same rank?)-disgust, joy, female, agreeableness, conscientiousness, anxiety

Model (2)  all participants (sellers and non-sellers) on all variables-Valence,  conscientiousness, anxiety, risk tolerance


--I'm not sure if we should use rank = 4 for all non-sellers or should we just use multinomial logit with 1 = first sellers, 2 = other sellers, and 3 =non-sellers.
