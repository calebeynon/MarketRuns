...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{first_seller_trait_violins.pdf}
  \caption{Distribution of personality traits by first seller status}
  \label{fig:first_seller_trait_violins}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{first_seller_rate_by_quartile.pdf}
  \caption{First seller rate by trait quartile}
  \label{fig:first_seller_rate_by_quartile}
\end{figure}
...
\begin{table}[H]
  \centering
  \caption{Linear probability model predicting first seller status}
  \label{tab:first_seller_lpm_regression}
  \input{first_seller_lpm_regression}
\end{table}

\subsection{Emotions and Traits on Selling Behavior}

% Full sample uses longtable (multi-page) - no table wrapper needed
\input{selling_emotions_traits_full}

\begin{table}[H]
  \centering
  \caption{Emotions and traits predicting selling period (first sellers)}
  \label{tab:selling_emotions_traits_first}
  \input{selling_emotions_traits_first}
\end{table}

\begin{table}[H]
  \centering
  \caption{Emotions and traits predicting selling period (second sellers)}
  \label{tab:selling_emotions_traits_second}
  \input{selling_emotions_traits_second}
\end{table}
