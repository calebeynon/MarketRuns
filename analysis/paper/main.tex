...
Table~\ref{tab:summary_demographics_traits} summarizes the subject pool. We recruited 96 subjects across 6 sessions (3 per treatment), with balanced demographics and personality traits across treatments; only conscientiousness differs significantly between treatments ($p<0.05$), while the remaining traits are well balanced. Table~\ref{tab:summary_sell_rates} compares average sell rates across treatment and chat conditions.
...
\begin{table}[H]
  \centering
  \caption{Average sell rates by treatment and chat condition}
