...
Experiment \cite{rustichini2016toward}

\cite{oehler2018investors} extraversion and neuroticism.
...
Table~\ref{tab:summary_demographics} summarizes the subject pool. We recruited 96 subjects across 6 sessions (3 per treatment), with balanced demographics across treatments. Table~\ref{tab:summary_traits} reports personality trait measures by treatment; only conscientiousness differs significantly between treatments ($p<0.05$), while the remaining traits are well balanced. Table~\ref{tab:trait_correlations} presents the pairwise correlations among the eight trait measures. Table~\ref{tab:summary_market_outcomes} compares market outcomes across the no-chat (Segments 1--2) and chat (Segments 3--4) conditions.

\begin{table}[H]
  \centering
  \caption{Subject pool and demographics}
  \label{tab:summary_demographics}
  \input{summary_demographics}
\end{table}

\begin{table}[H]
  \centering
  \caption{Personality traits by treatment}
  \label{tab:summary_traits}
  \input{summary_traits}
\end{table}
...
\begin{table}[H]
  \centering
  \caption{Market outcomes by chat condition}
  \label{tab:summary_market_outcomes}
  \input{summary_market_outcomes}
\end{table}
...
\begin{minipage}[t]{0.50\textwidth}
  ...
  \resizebox{\linewidth}{!}{\input{ordinal_logit_selling_position}}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.47\textwidth}
  ...
  \resizebox{\linewidth}{!}{\input{holdout_liquidation_regression}}
\end{minipage}
\end{table}
...
\section*{Appendix D. Personality Traits by First-Seller Frequency}
...
\section*{Appendix E. Instructions}
