...
Rank‐ordered logit model. individual ranks in a group (strata).  Traits. Emotions. Full sample and Sellers only (Appendix F)
...
\clearpage
% Ordinal logit table (standalone)
\begin{table}[H]
  \centering
...
\section*{Appendix F. Ranked-Order Logit Robustness Check}
