...
\begin{table}[H]
  \centering
  \caption{Summary market outcomes by treatment and chat condition}
  \label{tab:summary_sell_rates}
  \input{summary_sell_rates}
\end{table}
