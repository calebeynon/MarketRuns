...
\begin{itemize}
    ...
    \item Market runs differ from bank runs \citep{bernardo2004liquidity}:
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Experimental approach implementing \cite{bernardo2004liquidity} framework
...
\begin{enumerate}
    ...
    \item \textbf{Negative emotions predict selling:} Some negative emotions increases selling hazard
...
\begin{itemize}
    \item \cite{bernardo2004liquidity}: Theoretical model of market runs
...
\begin{itemize}
    ...
    \item Signal accuracy: $\mu_G = P(state = B | signal = bad) = 0.675$
...
\begin{itemize}
    ...
    \item TIDE Lab, University of Alabama, IRB approved and preregistered
...
\begin{itemize}
    ...
    \item Subjects then complete a quiz, average of 85\% correct first attempt
...
\vspace{0.3cm}
Treatment 1 is a mean-preserving spread
\end{frame}
