...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 4
    SEGMENT_NUMBER = 4  # This is the fourth segment
    
    # Generate random number of rounds for this segment
    #NUM_ROUNDS_IN_SEGMENT = 9 #min(np.random.geometric(p=0.125), 14)  # 1-14 rounds
    NUM_ROUNDS_IN_SEGMENT = 2
    
    # For each round, generate random number of periods
    #PERIODS_PER_ROUND = [5, 3, 11, 3, 6, 14, 6, 3, 1]
